...
class Dashboard:
    ...
    def initUI(self,db):
        ...
        self.Font_search_btn= font.Font(family="Helvetica",size=10,weight=15)
        ...
        self.search_label=Label(self.root,text="Search Notes",font=self.self.Font)
